...
![chaxun5](http://qiniu.hizmz.com/jc4-news-hzkd.gif)
		...
		if($keyword == "校园新闻") //keyword自己改 
		 {
			...
			*/
			...
			for($i=0;$i<8;$i++){
						...
						//$u ='http://www.ujs.edu.cn/'.$u;  //这里是根据你抓取到的网址进行补全
                         //比如你抓取到的是"news/11.html",而你原网址是"http://www.ujs.edu.cn/news/11.html",那你就需要补全了
