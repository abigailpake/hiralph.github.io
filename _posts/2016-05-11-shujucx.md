...
![chaxun1](http://qiniu.hizmz.com/jc5-cx.png)
...
![chaxun2](http://qiniu.hizmz.com/jc5-cx-sqlname.JPG)

## <a name="load"/>生成数据库文件

#### 下面我们学会将我们现有的xls表格数据导入到我们的数据库中，可看以下动画
![chaxun3](http://qiniu.hizmz.com/jc5-cx-xlstocsv.gif)
...
![chaxun4](http://qiniu.hizmz.com/jc5-cx-file.JPG)

#### ->3. 在浏览器中输入你的域名/shuju/cxtest.php,如我的是http://hi.wxhand.cn/shuju/cxtest.php,如图所示
![chaxun5](http://qiniu.hizmz.com/jc5-cx-show.JPG)
...
#### 最终效果
![chaxun5](http://qiniu.hizmz.com/jc5-cx-result.png)
...
#### 具体如下图
![chaxun6](http://qiniu.hizmz.com/cx-duo-new.jpg)
